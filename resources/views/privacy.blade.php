...
@section('content')
    ...
    <p>At Ceyecle, accessible from https://ceyecle.com, one of our main priorities is the privacy of our visitors. This
        Privacy Policy document contains types of information that is collected and recorded by Ceyecle and how we use it.
    </p>
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to
        the information that they shared and/or collect in Ceyecle. This policy is not applicable to any information
        collected offline or via channels other than this website. Our Privacy Policy was created with the help of the <a
            href="https://www.privacypolicygenerator.info/" style="font-size: 16px;">Privacy Policy Generator</a>.</p>
    ...
    <p>Ceyecle follows a standard procedure of using log files. These files log visitors when they visit websites. All
    ...
    <p>Like any other website, Ceyecle uses 'cookies'. These cookies are used to store information including visitors'
    ...
    <p>For more general information on cookies, please read <a href="https://www.privacypolicyonline.com/what-are-cookies/"
            style="font-size: 16px;">"What Are Cookies"</a>.</p>
    ...
    <p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to our
        ...
        following URL – <a href="https://policies.google.com/technologies/ads"
            style="font-size: 16px;">https://policies.google.com/technologies/ads</a></p>
    ...
    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on Ceyecle, which are sent directly to users' browser. They
    ...
    <p>Ceyecle's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
    ...
    <p>Ceyecle does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you

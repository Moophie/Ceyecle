...
@section('content')
    ...
    <p>These terms and conditions outline the rules and regulations for the use of Ceyecle's Website, located at
        https://ceyecle.com.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Ceyecle if you do
    ...
    <p>We employ the use of cookies. By accessing Ceyecle, you agreed to use cookies in agreement with the Ceyecle's Privacy
        Policy. </p>
    ...
    <p>Unless otherwise stated, Ceyecle and/or its licensors own the intellectual property rights for all material on
        Ceyecle. All intellectual property rights are reserved. You may access this from Ceyecle for your own personal use
    ...
    <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the <a
            href="https://www.termsandconditionsgenerator.com" style="font-size: 16px;">Terms And Conditions Generator</a>.
    </p>

    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas
        of the website. Ceyecle does not filter, edit, publish or review Comments prior to their presence on the website.
        Comments do not reflect the views and opinions of Ceyecle,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Ceyecle
    ...
    <p>Ceyecle reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate,
    ...
    <p>You hereby grant Ceyecle a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Ceyecle; and (d) the
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
        must inform us by sending an e-mail to Ceyecle. Please include your name, your organization name, contact
